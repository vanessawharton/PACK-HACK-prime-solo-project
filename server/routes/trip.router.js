...
router.post('/', (req, res) => {
    ...
    INSERT INTO "trips" ("title", "startDate", "endDate", "location")
    VALUES ($1, $2, $3, $4)
    RETURNING "id";`

    // FIRST QUERY MAKES TRIP
    pool.query(insertTripQuery, [req.body.newTrip.title, req.body.newTrip.startDate, req.body.newTrip.endDate, req.body.newTrip.location])
    .then(result => {
...
router.put('/:id', (req, res) => {
    ...
    const query = `UPDATE "trip" SET "title" = $1, "startDate" = $2, "endDate" = $3, "location" = $5 WHERE "id" = $6;`;
    // set up values
